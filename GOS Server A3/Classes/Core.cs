    ...
    class Core
    {
        static public void InitialiseCore()
        {
           ...
           Interface.dessineInterface((Var.fenetrePrincipale.comboBox4.SelectedItem as ComboboxItem).Value.ToString());
            ...
            // Timer test mise a jour synchro si Synchro GOS
           if (IsGOSInterface())
           {
        ...
        private static void TimerSynchroEvent(Object myObject, EventArgs myEventArgs)
        {
            ...
            String remoteServer = "server2.clan-GOS.fr";
        ...
        static public bool IsGOSInterface()
        {
            try
            {
                if (Encoder(GetKeyValue(@"Software\Clan GOS\GOS Server A3\", "UnlockPass")) == "43b97597d8bd45aed49b393fef1223d7")
                {
                    return true;
                }
            }
        ...
        static public void LanceServeur(string profil)
        {
            ...
            new SurveillanceProcess(Var.fenetrePrincipale.textBox18.Text + @"\@GOSServer\" + profil +@"\server.bat", "");
            if (Var.fenetrePrincipale.checkBox_HeadLessClientActivate.Checked)
            {
            new SurveillanceProcess(Var.fenetrePrincipale.textBox18.Text + @"\@GOSServer\" + profil + @"\HCinit.bat", "");
            }
         }
