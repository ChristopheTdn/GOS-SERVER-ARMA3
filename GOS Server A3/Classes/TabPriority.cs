...
namespace GOS_Server_A3.Classes
{
    class TabPriority
    {
        ...
        static private List<string> ListeModsValide()
        {
            ...
            // Template
            foreach (string ligne in ExtractionListeModsValides(Var.fenetrePrincipale.checkedListBox7, @"@GOS\@TEMPLATE\"))
            {
            ...
            // Casque Perso
            if (Var.fenetrePrincipale.radioButton20.Checked) { listeModsValide.Add(@"@GOS\@TEMPLATE\@GOSUnit_HelmetsST"); };
            if (Var.fenetrePrincipale.radioButton21.Checked) { listeModsValide.Add(@"@GOS\@TEMPLATE\@GOSUnit_HelmetsXT"); };

            // FRAMEWORK
            foreach (string ligne in ExtractionListeModsValides(Var.fenetrePrincipale.checkedListBox8, @"@GOS\@FRAMEWORK\"))
            {
                listeModsValide.Add(ligne);
            }

            // Islands
            foreach (string ligne in ExtractionListeModsValides(Var.fenetrePrincipale.checkedListBox1, @"@GOS\@ISLANDS\"))
            {
                listeModsValide.Add(ligne);
            }
            // Units
            foreach (string ligne in ExtractionListeModsValides(Var.fenetrePrincipale.checkedListBox2, @"@GOS\@UNITS\"))
            {
                listeModsValide.Add(ligne);
            }
            // Materiel
            foreach (string ligne in ExtractionListeModsValides(Var.fenetrePrincipale.checkedListBox3, @"@GOS\@MATERIEL\"))
            {
                listeModsValide.Add(ligne);
            }
            // Client
            foreach (string ligne in ExtractionListeModsValides(Var.fenetrePrincipale.checkedListBox6, @"@GOS\@CLIENT\"))
            {
                listeModsValide.Add(ligne);
            }
            // test
            foreach (string ligne in ExtractionListeModsValides(Var.fenetrePrincipale.checkedListBox4, @"@GOS\@TEST\"))
            {
                listeModsValide.Add(ligne);
            }
            // Autres MODS
