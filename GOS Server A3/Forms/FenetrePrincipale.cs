    ...
    public partial class FenetrePrincipale : Form
    {
        ...
        void label77_TextChanged(object sender, EventArgs e)
        {
            if (label77.Text.Replace(",", ".") == "0.000 Mo")
            {
                ...
                Var.fenetrePrincipale.pictureBox6.Image = GOS_Server_A3.Properties.Resources.crochet_ok_oui_icone_5594_64;
            }
            else
            {
                Var.fenetrePrincipale.label77.ForeColor = System.Drawing.Color.Red;
                Var.fenetrePrincipale.pictureBox6.Visible = true;
                Var.fenetrePrincipale.pictureBox6.Image = GOS_Server_A3.Properties.Resources.balle_fermer_cute_stop_icone_4372_64;
            };
        }
        ...
        private void checkBox21_CheckedChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                pictureBox26.Image = GOS_Server_A3.Properties.Resources.fermer_gtk_icone_6139_128;
                label34.Enabled = false;
                pictureBox28.Image = GOS_Server_A3.Properties.Resources.fermer_gtk_icone_6139_128;
                label35.Enabled = false;
                pictureBox30.Image = GOS_Server_A3.Properties.Resources.fermer_gtk_icone_6139_128;
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (comboBox3.Text)
            {
                ...
                case "1":
                    pictureBox26.Image = GOS_Server_A3.Properties.Resources.crochet_ok_oui_icone_5594_64;
                ...
                case "3":
                    pictureBox26.Image = GOS_Server_A3.Properties.Resources.crochet_ok_oui_icone_5594_64;
                    label34.Enabled = true;
                    pictureBox28.Image = GOS_Server_A3.Properties.Resources.crochet_ok_oui_icone_5594_64;
                ...
                case "5":
                    ...
                    pictureBox28.Image = GOS_Server_A3.Properties.Resources.fermer_gtk_icone_6139_128;
                    label35.Enabled = false;
                    pictureBox30.Image = GOS_Server_A3.Properties.Resources.crochet_ok_oui_icone_5594_64;
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    File.Delete(Var.RepertoireDeSauvegarde + listBox1.SelectedItem.ToString() + ".GOSServer.bin");
                }
                catch
                {
                }
        ...
        private void pictureBox5_Click(object sender, EventArgs e)
        {
            ...
            if (listBox1.SelectedItem != null)
            {
                ...
                Core.SetKeyValue(@"Software\Clan GOS\GOS Server A3\", "profil_favoris", (Var.fenetrePrincipale.listBox1.SelectedItem as ComboboxItem).Value.ToString());
            }
        }
        ...
        {
            System.Diagnostics.Process.Start("http://clan-GOS.fr/redmine/projects/GOS-server-arma-3/issues");
        }


        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            System.Diagnostics.Process.Start("https://github.com/ChristopheTdn/GOS-SERVER-ARMA3");
        }

        private void button22_Click(object sender, EventArgs e)
        {
            Interface.UnlockGOSServer();
        }

        private void linkLabel4_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            System.Diagnostics.Process.Start("http://forums.bistudio.com/showthread.php?161899-GOS-SERVER-Administrate-Multi-dedicated-servers-under-Windows-Environnement");
        }
